...
public class Cards {
	...
	public static void buildDependencyMap() {
		...
		String[] s7 = {"FORUM"};
		dependencyMap.put("WEST TRADING POST",s7);
		String[] s8 = {"FORUM"};
		dependencyMap.put("EAST TRADING POST",s8);
		String[] s9 = {"HAVEN"};
		dependencyMap.put("FORUM",s9);
		String[] s10 = {"CARAVANSERY"};
		dependencyMap.put("MARKETPLACE",s10);
		String[] s11 = {"FORTIFICATIONS"};
		dependencyMap.put("WALLS",s11);
		String[] s12 = {"CIRCUS"};
		dependencyMap.put("TRAINING GROUND",s12);
		String[] s13 = {"STABLES","DISPENSARY"};
		dependencyMap.put("APOTHECARY",s13);
		String[] s14 = {"ARENA","LODGE"};
		dependencyMap.put("DISPENSARY",s14);
		String[] s15 = {"ARCHERY RANGE","LABORATORY"};
		dependencyMap.put("WORKSHOP",s15);
		String[] s16 = {"SIEGE WORKSHOP","OBSERVATORY"};
		dependencyMap.put("LABORATORY",s16);
		String[] s17 = {"SENATE","UNIVERSITY"};
		dependencyMap.put("LIBRARY",s17);
		String[] s18 = {"ACADEMY","STUDY"};
		dependencyMap.put("SCHOOL",s18);
	}
